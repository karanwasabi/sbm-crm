...
export const EMAIL_PREVIEW_SAMPLE_VARS: Record<string, string> = {
  ...
  '{{referred.first_name}}': 'Priya',
  '{{referred.last_name}}': 'Sharma',
  '{{referred.full_name}}': 'Priya Sharma',
  '{{referred.email}}': 'priya.sharma@example.com',
  '{{member.program_name}}': 'Take Control',
  '{{member.cohort_name}}': 'Aug 2026',
  '{{member.cohort_month}}': 'August',
  '{{member.cohort_starts_on}}': '17th of August, 2026',
  '{{member.enrollment_status}}': 'Currently enrolled',
  '{{member.access_until}}': '19th of February, 2027',
  '{{renewal.category}}': 'returnee_no_sub',
  '{{renewal.category_label}}': 'Returnee',
  '{{renewal.plan_key}}': 'renewal_6m',
  '{{renewal.plan_label}}': '6 month renewal',
  '{{renewal.access_until}}': '2027-02-20T00:00:00Z',
  '{{renewal.access_until_label}}': '19th of February, 2027',
  '{{renewal.cohort_name}}': 'Aug 2026',
  '{{renewal.program_name}}': 'Take Control',
  '{{renewal.amount}}': '₹7,499',
  '{{renewal.months}}': '6',
  '{{renewal.months_label}}': '6 months',
