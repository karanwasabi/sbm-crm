...
export const MOCK_INTEGRATIONS: Integration[] = [
  {
    id: 'meta',
    name: 'Meta Lead Ads',
    subtitle: 'Last sync 2 min ago · 48 leads today',
    status: 'connected',
    color: '#5C65CF',
  },
  {
    id: 'whatsapp',
    name: 'WhatsApp (Convonite)',
    subtitle: 'Inbound bot active · 12 leads today',
    status: 'connected',
    color: '#10B981',
  },
  {
    id: 'website',
    name: 'Website forms',
    subtitle: '3 endpoints · 8 leads today',
    status: 'connected',
    color: '#0EA5E9',
  },
