...
export const EMAIL_VARIABLES: EmailVariable[] = [
  ...
  { token: '{{lead.batch}}', label: 'Batch (e.g. Aug 2026)' },
  ...
  { token: '{{referred.first_name}}', label: 'Referred first name' },
  { token: '{{referred.last_name}}', label: 'Referred last name' },
  { token: '{{referred.full_name}}', label: 'Referred full name' },
  { token: '{{referred.email}}', label: 'Referred email' },
  { token: '{{member.program_name}}', label: 'Program name', classifications: ['transactional'] },
  { token: '{{member.cohort_name}}', label: 'Cohort name (e.g. Aug 2026)', classifications: ['transactional'] },
  {
    token: '{{member.cohort_month}}',
    label: 'Cohort month (e.g. August)',
    classifications: ['transactional'],
  },
  {
    token: '{{member.cohort_starts_on}}',
    label: 'Cohort start date (e.g. 17th of August, 2026)',
    classifications: ['transactional'],
  },
  { token: '{{member.enrollment_status}}', label: 'Enrollment status', classifications: ['transactional'] },
  {
    token: '{{member.access_until}}',
    label: 'Access until (e.g. 19th of February, 2027)',
    classifications: ['transactional'],
  },
  ...
  {
    token: '{{renewal.plan_label}}',
    label: 'Renewal plan label (e.g. 6 month renewal)',
    classifications: ['transactional'],
  },
  {
    token: '{{renewal.months_label}}',
    label: 'Membership length (e.g. 6 months)',
    classifications: ['transactional'],
  },
  { token: '{{renewal.months}}', label: 'Membership months (number)', classifications: ['transactional'] },
  {
    token: '{{renewal.access_until_label}}',
    label: 'Membership ends (e.g. 19th of February, 2027)',
    classifications: ['transactional'],
  },
  {
    token: '{{renewal.access_until}}',
    label: 'Membership ends (raw ISO — prefer formatted)',
    classifications: ['transactional'],
  },
  ...
  { token: '{{coach.first_name}}', label: 'Coach first name', classifications: ['transactional'] },
  { token: '{{coach.last_name}}', label: 'Coach last name', classifications: ['transactional'] },
  { token: '{{coach.full_name}}', label: 'Coach full name', classifications: ['transactional'] },
  { token: '{{coach.email}}', label: 'Coach email', classifications: ['transactional'] },
  { token: '{{coach.whatsapp}}', label: 'Coach WhatsApp', classifications: ['transactional'] },
